...
import UserPostProfile from "./usersProfile";
...
const UserPostProfileWrapper = () => {
  const { userPosts } = useOutletContext<OutletContext>();

//   console.log("UserPostProfileWrapper - userPosts:", userPosts);

  // Include default posts from Feed component
  ...
  return <UserPostProfile allPosts={allPosts} />;
};

export default UserPostProfileWrapper;