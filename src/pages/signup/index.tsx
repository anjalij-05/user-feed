...
const Signup: React.FC = () => {
  ...
  // RHF setup with better default values
  const {
    register,
    handleSubmit,
    setValue,
  ...
  // FIXED: Better prefill logic with debugging
  useEffect(() => {
    if (checkinuser) {
      console.log("📋 Prefilling form with checkinuser data:", checkinuser);
      ...
      // Reset form with checkinuser data
      reset({
      ...
      toast.info("Your details have been prefilled from check-in", {
        className: "!bg-blue-800 !text-white !font-sans !font-regular tracking-wider",
      });
    }
  }, [checkinuser, reset]);
  ...
  const handleTempSave = async (file: File) => {
    try {
      ...
      const imageKey = res.data?.key || res.data?.data?.key || res.data?.url || res.data?.Key || res.data?.data?.Key;
  ...
  const onSubmitRegister = async (data: RegisterForm) => {
    try {
      ...
      console.log("📤 Sending registration payload:", registerPayload);
  ...
  return (
    <div className="relative flex justify-center items-center min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 overflow-hidden py-8">
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-start gap-8 lg:gap-12">
          ...
          <div className="flex-1 space-y-6 animate-slide-in-left lg:sticky lg:top-8">
            ...
            {/* Show checkin info if available */}
            {checkinuser && (
              <div className="bg-gradient-to-r from-blue-100 to-purple-100 border border-blue-200 rounded-xl p-4 animate-fade-in">
                ...
                <p className="text-xs text-primary">
                  We've prefilled your details from the {checkinuser.eventName} event check-in
                </p>
              </div>
            )}
            ...
            <div className="hidden lg:block mt-8">
              <div className="relative w-full h-48">
                <div className="absolute top-0 left-0 w-32 h-32 bg-gradient-to-br from-blue-400 to-purple-400 rounded-full opacity-20 blur-2xl animate-pulse" />
                <div
                  className="absolute bottom-0 right-0 w-40 h-40 bg-gradient-to-br from-purple-400 to-pink-400 rounded-full opacity-20 blur-2xl animate-pulse"
          ...
          <div className="w-full lg:w-auto lg:min-w-[500px] animate-slide-in-right">
            <div className="bg-white/90 backdrop-blur-xl p-6 sm:p-8 rounded-3xl shadow-2xl border border-white/20">
              {/* Form Header */}
                ...
                <div className="flex flex-col items-center pb-2">
                  ...
                  <div className="relative group">
                    <img
                      ...
                      alt="Profile Preview"
                      className="rounded-full w-28 h-28 object-cover border-4 border-gradient-to-r from-blue-500 to-purple-600 shadow-lg transition-transform group-hover:scale-105"
                    />

                    <button
                      type="button"
                      className="absolute bottom-0 right-0 bg-gradient-to-r from-blue-600 to-purple-600 text-white p-2.5 rounded-full shadow-lg hover:shadow-xl transform hover:scale-110 transition-all"
                  ...
                  <div className="flex gap-3">
                    <div className="relative">
                      ...
                      <Input
                        ...
                        type="text"
                        placeholder="91"
                        className={`w-20 h-12 pl-7 font-medium text-center ${
                          errors.countryCode
                            ? "border-red-500"
                            : "border-gray-200"
                        } focus:border-purple-500 focus:ring-2 focus:ring-purple-200 transition-all`}
